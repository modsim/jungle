...
/**
 * {@link TrackMateActionFactory} for a {@link JungleExporter}.
 * 
...
public class JungleExporterFactory implements TrackMateActionFactory
{
	...
	public static final String INFO_TEXT = "<html>Export the current model content to an XML file that can be " + "viewed in the visualization tool developed in the master project of" + "Stefan Helfrich." + "<p> " + "Both tracks and information about cells are exported." + "</html>";
