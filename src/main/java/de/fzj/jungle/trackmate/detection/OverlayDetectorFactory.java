...
import de.fzj.jungle.trackmate.gui.panels.detector.OverlayDetectorConfigurationPanel;
...
public class OverlayDetectorFactory< T extends RealType< T > & NativeType< T > > implements SpotDetectorFactory< T >
{
	...
	{
		return new OverlayDetectorConfigurationPanel( settings.imp, INFO_TEXT, NAME, model );
	}
